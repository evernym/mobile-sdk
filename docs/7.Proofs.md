...
* `proof_request_data[name]` - title of proof request (`title` field of  application Proof object).
* `proof_request_data[request_attributes]` - list of attributes requested for proof (`request_attributes` field of  application Proof object).
* `proof_request_data[requested_predicates]` - list of predicates requested for proof (`requested_predicates` field of  application Proof object).
* `thread_id` - Identifier of present proof protocol.  (`threadId` field of  application Proof object).
