...
The path to this file will be used as `path` parameter of SDK provisioning config.
...
Use `Agency Url`, `Agency DID`, and `Agency Verification Key` values in the particular environment to prepare `agency_did`, `agency_url`, and `agency_verkey` fields in the SDK initialization config.

> **NOTE:** To run one of the example apps, you will have to update the Pool Genesis Transactions file and SDK initialization configs with values for the [**`demo`**](../environments/DemoEnvironment.md) environment. 
