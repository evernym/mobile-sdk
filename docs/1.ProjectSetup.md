...
* **Currently recommended versions**
  ...
  * Android:
      * `com.evernym:vcx:0.13.1-d69198c@aar`
...
4. Add `pod 'vcx', '0.0.227'` in Podfile inside `target <ProjectName>`

    * `vcx 0.0.227` should be used to run applications on phones
    * `vcx 0.0.228` should be used to run applications on simulators
