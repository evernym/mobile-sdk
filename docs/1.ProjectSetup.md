...
<!-- 
  these are the steps once we have this repository in open source
-->
<!-- 
3. Add below files to top of `Podfile`
...
4. Add `pod 'vcx', 0.0.191` in Podfile inside `target <ProjectName>`
5. Run `pod install`

-->

1. From this repo, copy vcx.podspec file to your project root folder and add it's path to your Podfile. Open Podfile in any editor and add this line: 
