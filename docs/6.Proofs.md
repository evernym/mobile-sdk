...
> **NOTE:** there must be established connection between Prover and Verifier. See [connections document](4.Connections.md)

> **NOTE:** there must be at least on credential stored in the Holder's wallet. See [credentials document](5.Credentials.md)
...
You are ready to ready how to [reply to secure questions](7.StructuredMessages.md).
