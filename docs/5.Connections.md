...
To send this type of invitation from the Verity application, you need to use [this API call](https://app.swaggerhub.com/apis/evernym/verity-rest-api/1.0#/Relationship/relationship) with [this](https://app.swaggerhub.com/apis/evernym/verity-rest-api/1.0#/OutOfBandInvitationRequest) body payload.
