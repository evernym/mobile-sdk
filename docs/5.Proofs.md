...
The only difference that they imply additional restriction: the same credential must be used for their proving.
...
2. Parse pending message
    ...
    Extract proof request JSON string from message.
