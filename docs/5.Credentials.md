...
> **NOTE:** there must be established connection between Issuer and Holder. See [connections document](4.Connections.md)
...
1. Store serialized Credential state object for latter operations. \
...
1. Delete credential data from the application storage.

## Next Step

Now your application is able to receive and store verifiable credentials.
You are ready to ready how to [fill proof requests](6.Proofs.md) using credentials in your wallet.
