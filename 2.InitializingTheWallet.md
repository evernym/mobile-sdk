...
If you want to use a different Ledger follow to steps below:
...
In case you want to try some other configurations, this is list of currently existing ones: [https://github.com/sovrin-foundation/sovrin/tree/master/sovrin](https://github.com/sovrin-foundation/sovrin/tree/master/sovrin). 

> Note: Look only for files with this name structure: **domain_transactions_*_genesis**
...
#### Agency
If you choose to use a different Agency follow to steps below: 
