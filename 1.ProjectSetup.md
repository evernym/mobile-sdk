...
> **NOTE:** Current version of libVcx does not support 32-bit devices and 64-bit devices with 32-bit Android version installed.
...
4. You are now ready to start adding calls to your code to [initialize the wallet](2.%20Initialization.md).

### Android

See [initialization documentation](2.%20Initialization.md).