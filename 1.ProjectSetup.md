...
We also prepared example code for your easy start, please check out **/Examples** folder in this repository. You will find both projects for both platforms (iOS and Android) and in languages you need: for iOS ObjC or Swift and for Android: Java or Kotlin. 
...
1. Create a new Xcode project using the Xcode New Project wizard. If you have existing project, skip to the [step 2](#2-add-dependency-libraries).
...
4. It is also important to use one of the latest library versions, which you can find using this link: <a href="https://github.com/evernym/mobile-sdk/releases" target="_blank">https://github.com/evernym/mobile-sdk/releases</a>. From list of versions, press **Assets** link bellow choosen version and right click > copy url for "vcx.libvcxall_*versionNumber*_universal.zip". 
 ...
 - Add this copied url path to the vcx zip file into vcx.podspec, on line 14, for **s.source** attribute. 
...
This command will download required vcx library to your local folder and include it in the project. VCX library is around 60mb, so command execution could take a few minutes.
