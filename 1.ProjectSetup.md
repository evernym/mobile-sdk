...
In order to any of our mobile applications work properly, you will need to download and prepare prerequisite libraries, which we will use in next steps in this document. 

You can find all necessary libraries inside same MobileSDK repo, in section **Releases**:
[Download Here](https://github.com/evernym/mobile-sdk/releases?target=_blank).
