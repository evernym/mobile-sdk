        ...
        Executors.newSingleThreadExecutor().execute(() -> {
            try {
                ...
                if (ConnectionInvitation.isAriesOutOfBandConnectionInvitation(invitationType) && attachment != null) {
                    ...
                    if (ConnectionInvitation.isCredentialAttachment(attachmentType)) {
                    ...
                    if (ConnectionInvitation.isProofAttachment(attachmentType)) {
                        JSONObject decodedProofAttach = ProofRequest.decodeProofRequestAttach(attachment);
