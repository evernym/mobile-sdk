...
through to the libvcx shared library.
  ...
  s.source           = { :http => 'https://github.com/evernym/mobile-sdk/releases/download/15806/vcx.libvcxpartial_0.8.70225799-dbaa2c43b_universal.zip'  }
