...
# vdr-tools 0.8.0
# libvcx 0.12.0-e2e5c16a

Pod::Spec.new do |s|
  s.name             = 'vcx'
  s.version          = '0.0.219'
  s.summary          = 'The Objective-C wrapper around the libvcx shared library for phones.'
...
through to the libvcx shared library.
  ...
  s.source           = { :http => 'https://gitlab.com/evernym/mobile/mobile-sdk/-/package_files/21017029/download', :type => 'zip' }
